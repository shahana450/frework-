...
export const metadata: Metadata = {
  ...
  title: {
    default: "FreWork – GST Registration, ITR Filing & Business Services Online India",
    template: "%s | FreWork",
  },
  description:
    "FreWork is India's all-in-one business platform. GST registration, ITR filing, company registration, accounting, coworking spaces and freelance professionals — all in one place. Start, run and grow your business.",
  keywords: [
    "FreWork",
    "frework.online",
    "FreWork India",
  ...
  openGraph: {
    ...
    description:
      "FreWork is India's all-in-one business platform — GST registration, ITR filing, company registration, coworking spaces and expert professionals at your fingertips.",
    siteName: "FreWork",
    images: [{ url: "/og-image.png", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "FreWork – GST Registration, ITR Filing & Business Services India",
    description: "GST registration, ITR filing, company registration and business services online. India's all-in-one business platform.",
    creator: "@frework",
    images: ["/og-image.png"],
  },
  robots: {
            ...
            "@graph": [
              {
                ...
                "name": "FreWork",
                "alternateName": ["FreWork India", "FreWork Online", "frework"],
                "url": "https://frework.online",
                "logo": "https://frework.online/logo.png",
                "description": "FreWork is India's all-in-one business operating system — GST registration, ITR filing, company registration, coworking spaces, freelance professionals and accounting services online.",
              ...
              },
              {
                ...
                "name": "FreWork",
                "alternateName": ["FreWork India", "FreWork Online", "frework"],
                "description": "FreWork — India's all-in-one business platform for GST registration, ITR filing, company registration, coworking and expert professionals.",
