...
export const metadata: Metadata = {
  ...
  keywords: ["hire CA online India","freelance CA India","hire chartered accountant","hire lawyer India","find CS online","verified freelancers India","hire developer India","FreWork freelancers"],
  openGraph: {
