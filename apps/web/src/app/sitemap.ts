...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/blog/gst-filing-guide`,           lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    { url: `${BASE_URL}/blog/itr-filing-guide`,           lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    { url: `${BASE_URL}/blog/itr-filing-salaried`,        lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    { url: `${BASE_URL}/blog/company-registration-india`, lastModified: now, changeFrequency: "monthly", priority: 0.78 },
    { url: `${BASE_URL}/blog/msme-registration-guide`,    lastModified: now, changeFrequency: "monthly", priority: 0.76 },
