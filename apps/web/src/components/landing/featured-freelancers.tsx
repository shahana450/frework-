...
const freelancers = [
  ...
  },
  {
    ...
    reviews: 312,
    hourlyRate: 95,
    skills: ["Figma", "Branding", "Motion Design", "Webflow"],
    verified: true,
    availability: "Busy",
    badge: "Top Rated",
    badgeColor: "bg-yellow-500",
  ...
  },
  {
    ...
    reviews: 98,
    hourlyRate: 110,
    skills: ["Contract Law", "M&A", "IP Rights", "Compliance"],
    verified: true,
    availability: "Available",
    badge: "Expert",
    badgeColor: "bg-brand-500",
                ...
                <div className="group relative bg-card border border-border rounded-2xl p-6 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 cursor-pointer">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    <div>
                      ...
                      <p className="text-base font-bold">${f.hourlyRate}<span className="text-xs font-normal text-muted-foreground">/hr</span></p>
                    </div>
