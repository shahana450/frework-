...
const faqs = [
  {
    q: "How does WorkSphere verify freelancers?",
  ...
  },
  {
    ...
    a: "When a client hires a freelancer, the agreed amount is held securely in WorkSphere escrow. Funds are released milestone by milestone as work is approved. In case of disputes, our resolution team mediates within 48 hours.",
  },
  {
    q: "Can I book a coworking space for a team?",
    a: "Absolutely. You can book anywhere from 1 hot desk to entire floors. Corporate accounts get centralized billing, booking management for your whole team, and access to 5,000+ verified spaces in 150+ cities.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. WorkSphere is available on iOS and Android with full feature parity. You can manage projects, chat with clients, book workspaces, and track payments on the go.",
  },
  {
    q: "What's the platform fee?",
    a: "WorkSphere charges a 5% platform fee on transactions, which is among the lowest in the industry. The fee covers payment processing, escrow, dispute resolution, and platform maintenance. Enterprise plans have custom fee structures.",
  },
  {
    q: "Can agencies use WorkSphere?",
