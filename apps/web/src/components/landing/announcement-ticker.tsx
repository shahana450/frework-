...
export function AnnouncementTicker() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 flex items-center gap-3 h-9">

        {/* Left: LIVE badge */}
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <span className="flex items-center gap-1 px-2 py-0.5 rounded text-[9px] font-black tracking-widest"
            style={{ background: "rgba(220,38,38,0.9)", color: "#fff" }}>
            <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
            LIVE
          </span>
          <Bell size={11} style={{ color: "#B8903A" }} />
        </div>

        {/* Separator */}
        <div className="w-px h-4 flex-shrink-0" style={{ background: "rgba(184,144,58,0.3)" }} />
        ...
        <div className="flex-1 overflow-hidden">
          <AnimatePresence mode="wait">
            ...
            >
              <span className="flex-shrink-0 text-[9px] font-black tracking-wider px-1.5 py-0.5 rounded"
              ...
              <a
                ...
                className="text-[11px] font-medium leading-none truncate transition-colors hover:text-white cursor-pointer"
        ...
        {/* Separator */}
        <div className="hidden sm:block w-px h-4 flex-shrink-0" style={{ background: "rgba(184,144,58,0.3)" }} />

        {/* Auth buttons */}
        <div className="flex items-center gap-2 flex-shrink-0">
          <Link href="/login"
            className="hidden sm:inline-flex items-center gap-1 px-3 py-1 rounded-lg text-[11px] font-bold transition-all hover:bg-white/10"
          ...
          <Link href="/register"
            ...
            style={{
              ...
              color: "#1A1208",
              boxShadow: "0 2px 8px rgba(184,144,58,0.4)",
            }}>
            <UserPlus size={10} />
